...
public class VoiceProcessor : MonoBehaviour
{
    ...
    /// <summary>
    /// Frecuencia efectiva del AudioClip de micrófono de la sesión actual.
    /// Se expone únicamente para diagnóstico; no cambia la captura.
    /// </summary>
    public int ActualSampleRate => _audioClip != null ? _audioClip.frequency : 0;

    /// <summary>
    /// Cantidad de canales del AudioClip de micrófono de la sesión actual.
    /// Se expone únicamente para diagnóstico; no cambia la captura.
    /// </summary>
    public int Channels => _audioClip != null ? _audioClip.channels : 0;
